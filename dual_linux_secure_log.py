...
def fun_resolve_linux_secure_log(v_LogFile):
    i=0
    cnt=0
    list_sql=[]
    ...
    try:
        with open(v_LogFile,'r', encoding='utf-8') as f:
            ...
            while i < rowcount:
                   ...
                   if len(line) > 1 :
                          ...
                          if iso_8601[0:13] == one_dt:
                              ...
                              event = event.replace("'", "\\\'")
                              v_sql = "insert into t_data_linux_secure_log(iso_8601,ctime,host,process_id,event) " \
            ...
            add_record=fun_insert_table(list_sql,'t_data_linux_secure_log')
...
if __name__ == '__main__':
    fun_resolve_linux_secure_log(r'secure')
    #str_ctime = 'Sep 14 16:48:06'
    #fun_iso_8601(str_ctime)
